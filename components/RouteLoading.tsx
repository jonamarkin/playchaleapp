...
export default function RouteLoading() {
  return (
    ...
    <div className="min-h-[130vh] flex flex-col items-center pt-[40vh] gap-4 bg-[#FDFDFB]" role="status" aria-live="polite">
      <div className="w-10 h-10 border-4 border-black/10 border-t-[#C6FF00] rounded-full animate-spin" />
