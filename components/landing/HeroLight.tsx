...
const HeroLight: React.FC = () => {
  ...
  return (
    <section className="relative bg-surface-app overflow-x-clip px-4 md:px-12 pb-8 md:pb-12">
      ...
      <nav className="relative z-20 max-w-7xl mx-auto py-6 md:py-8 flex justify-between items-center">
        ...
        {!user ? (
          ...
          <Link
            href="/home"
            className="bg-black text-lime-500 px-5 py-2.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] hover:scale-105 transition-transform"
          >
            Go to Dashboard
          </Link>
        )}
      ...
      <div className="relative z-10 max-w-7xl mx-auto pt-6 md:pt-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 md:space-y-10">
            <div className="animate-in fade-in slide-in-from-left-5 [animation-duration:500ms] inline-flex items-center gap-3 bg-black text-lime-500 px-5 py-2 rounded-full font-black text-[10px] uppercase tracking-[0.4em]">
            ...
            <h1 className="animate-in fade-in slide-in-from-bottom-10 [animation-duration:600ms] [animation-delay:100ms] fill-mode-both text-5xl sm:text-6xl md:text-7xl lg:text-[5.25rem] xl:text-[6rem] font-black tracking-tighter italic leading-[0.9] uppercase text-black">
              Step Out, <br />
              <span className="text-lime-500 bg-black px-3 md:px-4 mt-2 inline-block transform -rotate-1 shadow-2xl">PlayChale.</span>
            </h1>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-5 [animation-duration:600ms] [animation-delay:400ms] fill-mode-both flex flex-col sm:flex-row items-stretch sm:items-center gap-6">
              <Link
                href="/discover"
                className="touch-target bg-black text-white px-8 py-5 md:px-10 md:py-6 rounded-full font-black uppercase tracking-widest text-[11px] flex items-center justify-center gap-4 hover:bg-lime-500 hover:text-black transition-all group shadow-xl"
              >
                Discover Games
                <div className="bg-lime-500 text-black group-hover:bg-black group-hover:text-lime-500 rounded-full p-1 transition-all group-hover:rotate-45">
                  <ICONS.ChevronRight />
                </div>
              </Link>
          ...
          <div className="lg:col-span-5 animate-in fade-in zoom-in-95 [animation-duration:700ms] [animation-delay:200ms] fill-mode-both">
            <div className="relative aspect-[4/3] sm:aspect-[16/10] lg:aspect-[4/5] rounded-[40px] md:rounded-[56px] overflow-hidden shadow-2xl border-4 border-white group">
              ...
              <div className="absolute top-6 left-6">
                <span className="inline-flex items-center gap-2 bg-lime-500 text-black px-4 py-2 rounded-full text-[9px] font-black uppercase tracking-[0.3em]">
