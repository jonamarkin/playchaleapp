      ...
      <div className="max-w-7xl mx-auto space-y-12 md:space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-14">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            >
              <img src={upcomingGames[0].imageUrl} className="w-full h-full object-cover transition-transform duration-[2s] group-hover:scale-110" />
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {upcomingGames.slice(1, 3).map(game => (
                  ...
                  >
                    <img src={game.imageUrl} className="w-24 h-24 rounded-[32px] object-cover shadow-lg" />
          ...
          <div className="lg:col-span-4 space-y-12">
            ...
            <div className="bg-black text-white rounded-[60px] p-10 space-y-10 shadow-2xl relative overflow-hidden">
              ...
              <div className="flex items-center gap-8 relative z-10">
                <img src={player.avatar} className="w-24 h-24 rounded-full border-4 border-[#C6FF00] shadow-2xl" />
                <div>
