...
const TestimonialCard: React.FC<TestimonialCardProps> = ({ testimonial }) => {
  return (
    <div className="group grid grid-cols-1 lg:grid-cols-12 gap-0 md:gap-4 h-auto bg-surface-sunken rounded-[64px] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-700">
      {/* Quote Section */}
      ...
      <div className="lg:col-span-3 bg-black/5 p-10 md:p-16 flex flex-col justify-between items-start border-y lg:border-y-0 lg:border-x border-white/40">
        ...
        <div className="mt-12 lg:mt-0 space-y-4">
          <div className="flex items-end gap-3 group/stat">
            <span className="text-8xl font-black tracking-tighter leading-none group-hover/stat:text-lime-500 transition-colors duration-500">{testimonial.statValue}</span>
      ...
      <div className="lg:col-span-4 p-4 lg:p-6 h-80 lg:h-auto">
        <div className="w-full h-full relative overflow-hidden rounded-[48px]">
          <Image
            ...
            className="object-cover group-hover:scale-110 transition-transform [transition-duration:2000ms]"
          />
