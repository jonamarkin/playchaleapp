                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input 
                        ...
                        className="w-full bg-white/5 border-2 border-white/5 focus:border-[#C6FF00] rounded-full px-6 py-4 text-white font-bold outline-none transition-all"
                      />
                    </div>
                    <ProSelect 
                      label="Main Discipline"
                      value={profileForm.mainSport!}
                      onChange={v => setProfileForm({...profileForm, mainSport: v})}
                      options={['Football', 'Basketball', 'Tennis', 'Padel', 'Badminton']}
                      iconMap={SPORT_ICONS}
                    />
                  </div>
                  <div className="space-y-2">
                ...
                <motion.form key="create-view" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} onSubmit={handleCreateSubmit} className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <ProSelect 
                      ...
                      onChange={v => setCreateForm({...createForm, sport: v})}
                      options={['Football', 'Basketball', 'Tennis', 'Padel', 'Badminton']}
                      iconMap={SPORT_ICONS}
                    />
                    <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <ProSelect 
                      ...
                      onChange={v => setCreateForm({...createForm, skillLevel: v as any})}
                      options={['All Levels', 'Beginner', 'Intermediate', 'Competitive']}
                    />
                  </div>
